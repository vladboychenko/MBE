...
public class JCornerCard extends JAbstractCard {
...
private static final long serialVersionUID = 1L;
	...
	public JCornerCard(String name, String logoName) {
		this.name = name;
	...
	public void paintCard() {
        ...
        JLabel picLabel = new JLabel(new ImageIcon(myPicture.getScaledInstance(100, 100, Image.SCALE_DEFAULT)));
